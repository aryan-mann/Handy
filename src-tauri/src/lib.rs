...
pub fn run() {
    ...
    let specta_builder = Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        shortcut::change_ai_rewrite_enabled_setting,
        shortcut::change_ai_rewrite_api_key_setting,
        shortcut::change_ai_rewrite_model_setting,
        shortcut::change_ai_rewrite_system_prompt_setting,
